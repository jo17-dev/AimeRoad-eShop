// AVERTISSEMENT: ceci est un fichier temporaire, Non factorisé
// Je vais le suprimer et update les fonctions dans les prochains commits 
...
const createFormElement = (inputsType=["text"], targetNames=["nom"] ,inputsNumbers=1, placeholder=["entrez la valeur"], required=[])=>{
    ...
    form.setAttribute("action", "?action=modifierClient");
